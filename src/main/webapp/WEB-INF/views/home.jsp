...
<div class="container">
	...
	<!-- 
	 ...
	 -->
	<!-- 기존맵핑명 resources를 servlet-context 에서 res로 변경 -->
<!-- 	<img src="./resources/1.png" width="200" alt="" /> -->
...
<!-- 			<a href="./home/HelloSpring" target="_blank"> -->
	...
	<h3>form값 처리하기</h3>
	<li>
		<!-- 새로운창이떠야 폼을 유지할수 있기때문에? 타겟을 블랭크로 항상 지정 -->
